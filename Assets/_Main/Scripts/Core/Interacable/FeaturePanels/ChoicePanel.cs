...
public class ChoicePanel : MonoBehaviour
{
    ...
    private const float BUTTON_HEIGHT_PER_LINE_PADDING = 20;
    ...
    private void Start()
    {
        cg = new CanvasGroupController(this, canvasGroup, 4);
        cg.alpha = 0;
    ...
    private IEnumerator GenerateChoices(string[] choices)
    {
        ...
        foreach (var button in buttons)
        {
            ...
            button.layout.preferredHeight = BUTTON_HEIGHT_PER_LINE_PADDING + (BUTTON_HEIGHT_PER_LINE * lines);
        }
