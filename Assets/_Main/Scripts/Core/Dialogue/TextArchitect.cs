...
/// </summary>
   ...
   private const float baseSpeed = 2.3f;
...
/// <summary>
/// Resets the @buildProcess and @hurryUp 
/// </summary>
   ...
   private IEnumerator Build_fade()
   {
      ...
      while (true)
      {
         float fadeSpeed = (hurryUp ? charactersPerCycle * 5 : charactersPerCycle) * speed;
